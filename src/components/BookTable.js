...
const BookTable = ({ onClose }) => {
  ...
  const [isBookingAlertPopupOpen, setBookingAlertPopupOpen] = useState(false);
  ...
  const closeBookingAlertPopup = useCallback(() => {
    setShowSecondForm(true);
    setBookingAlertPopupOpen(false);
  }, []);
  ...
  return (
    <>
      ...
      {isBookingAlertPopupOpen && (
        <BookingAlert onClose={closeBookingAlertPopup} />
      )}
